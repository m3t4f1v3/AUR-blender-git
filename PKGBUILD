...
source=("git+https://github.com/blender/blender.git${_fragment}"
        'blender-addons.git::git+https://github.com/blender/blender-addons.git'
        'blender-addons-contrib.git::git+https://github.com/blender/blender-addons-contrib.git'
        'blender-translations.git::git+https://github.com/blender/blender-translations.git'
        'blender-dev-tools.git::git+https://github.com/blender/blender-dev-tools.git'
